...
- Supported clients: [Java](https://github.com/dotnet/aspnetcore/tree/main/src/SignalR/clients/java/signalr), [Swift](https://github.com/dotnet/signalr-client-swift/), [.NET](https://github.com/Azure/azure-signalr), [JavaScript (WebPubSub chat client)](https://github.com/Azure/azure-webpubsub/tree/main/sdk/webpubsub-chat-client)

> **Note:** The JavaScript WebPubSub chat client talks to Azure Web PubSub through a small local negotiate server and requires its own connection string (`E2E_WEBPUBSUB_CHAT_CONNECTION_STRING`). See [`webpubsub/javascript/chatclient/README.md`](./webpubsub/javascript/chatclient/README.md).
...
| JavaScript (WebPubSub chat client) | [`Azure/azure-webpubsub`](https://github.com/Azure/azure-webpubsub) `main` branch (`sdk/webpubsub-chat-client`, built from source) | Latest published [`@azure/web-pubsub-chat-client`](https://www.npmjs.com/package/@azure/web-pubsub-chat-client) on npm |
...
| JavaScript (WebPubSub chat client) | [`Azure/azure-webpubsub@main`](https://github.com/Azure/azure-webpubsub/tree/main/sdk/webpubsub-chat-client) (GitHub submodule) | [`1.0.0-beta.2`](https://www.npmjs.com/package/@azure/web-pubsub-chat-client) (npm) |
